...
export const metadata = meta(
  ...
  "Платите, только когда продаёте: комиссия с оборота без скрытых платежей, ступенчатая шкала и 3% в первый месяц для новых селлеров. Посчитайте комиссию в калькуляторе.",
);
  ...
  return (
    <>
      ...
      <FinalCTA
        ...
        sub="Первый месяц — сниженная комиссия на весь оборот."
        cta="Начать с 3%"
        param="site_pricing"
      />
    </>
