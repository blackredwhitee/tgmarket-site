...
const STEPS: Step[] = [
  ...
  { title: "Выберите статус", text: "Самозанятый, ИП или юридическое лицо.", note: "[УТОЧНИТЬ] Какие данные запрашивает бот", scene: "chat", msgs: [{ text: "Выберите ваш статус:", buttons: ["Самозанятый", "ИП", "Юрлицо"] }, { me: true, text: "Самозанятый" }, { text: "Отлично. Теперь укажите данные для проверки. [УТОЧНИТЬ]" }] },
  { title: "Укажите, куда получать деньги", text: "Подключите выплаты — бот подскажет, что заполнить.", note: "[УТОЧНИТЬ] Процесс подключения выплат и проверки", scene: "chat", msgs: [{ text: "Куда перечислять выручку?", buttons: ["Добавить реквизиты"] }, { me: true, text: "Реквизиты отправлены" }, { text: "Проверяем данные. Обычно это занимает [УТОЧНИТЬ]." }] },
  ...
  { title: "Опубликуйте в канале", text: "Карточка с кнопкой оплаты появляется в вашей ленте.", note: "[УТОЧНИТЬ] Механика публикации — бот-админ канала или пересылка поста", scene: "post" },
...
const BUYER: { n: number; scene: PhoneScene; text: string }[] = [
  ...
  { n: 3, scene: "done", text: "Получает подтверждение оплаты. [УТОЧНИТЬ] Как получает товар или доступ." },
];

const MONEY = [
  { title: "Когда приходят деньги", text: "[УТОЧНИТЬ] Сроки и график выплат.", icon: "M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zM12 6v6l4 2", bg: "#F2F3F7", fg: "#0B1233", iconBg: "#0B1233", iconFg: "#FFE14A" },
  ...
  { title: "Чеки и налоги", text: "[УТОЧНИТЬ] Кто формирует чеки для самозанятых, ИП и юрлиц.", icon: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8", bg: "#FFE14A", fg: "#0B1233", iconBg: "#0B1233", iconFg: "#fff" },
];
