...
const STEPS: Step[] = [
  { n: 1, title: "Получите ссылку", text: "Персональная ссылка — в боте: «Вывод средств» → «О реферальной программе».", bg: "#F5F7FE", fg: "#0B1233", numBg: "#FB7E5E", numFg: "#fff", line: "#C9D4FF" },
  { n: 2, title: "Рекомендуйте TG Market", text: "Клиентам, подписчикам, коллегам, которые продают в Telegram.", bg: "#E6F6FF", fg: "#0B1233", numBg: "#0B1233", numFg: "#fff", line: "#BDE7FF" },
  { n: 3, title: "Получайте до 1%", text: "От 0,5% до 1% с оборота каждого приведённого селлера в течение первого года. Вывод в любой момент — от 1 000 ₽.", bg: "#FB7E5E", fg: "#fff", numBg: "#7BD0FF", numFg: "#0B1233", line: "rgba(255,255,255,.4)" },
];
