...
const STEPS: Step[] = [
  ...
  { n: 3, title: "Получайте до 1%", text: "От 0,5% до 1% с оборота каждого приведённого селлера в течение первого года. Вывод в любой момент — от 1 000 ₽.", bg: "#1D4FFA", fg: "#fff", numBg: "#FFE14A", numFg: "#0B1233", line: "rgba(255,255,255,.4)" },
];
