...
const ADVS: { icon: string; title: string; text: string; note?: string }[] = [
  ...
  { icon: P.percent, title: "Комиссия только с продаж", text: "Платите процент с оборота, а не за подключение.", note: "[УТОЧНИТЬ] Нет абонентской платы и платы за подключение" },
  { icon: P.layers, title: "Всё в одном боте", text: "Карточки, продажи и статистика — в @TGMarketSellerBot.", note: "[УТОЧНИТЬ] Функции бота" },
];
