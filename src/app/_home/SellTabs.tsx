...
const TABS = [
  ...
  },
  {
    ...
    lead: "Платный доступ к закрытому каналу, чату или библиотеке материалов — бот сам добавляет оплативших", exTitle: "Подписка на закрытый канал", exPrice: "990 ₽ в месяц · или бессрочно", btn: "Оформить подписку",
