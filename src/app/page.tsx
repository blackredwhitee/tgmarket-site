...
export const metadata = meta(
  ...
  "Создайте карточку товара в боте, опубликуйте в своём канале и принимайте оплату по СБП от подписчиков. Для самозанятых, ИП и юрлиц. Первым селлерам — 3% на 2 месяца.",
);
